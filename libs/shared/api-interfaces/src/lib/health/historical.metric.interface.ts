import { HealthStatus, HealthData } from './health.interface';
...
/**
 * Historical health metrics for tracking over time
 */
export interface HistoricalHealthMetrics {
  timestamp: string;
  status: HealthStatus;
...
/**
 * Historical health data with extended tracking information
 */
