...
Our documentation follows a consistent, patriotic color palette that symbolizes ForgeBoard's commitment to data provenance and American values.
...
:root {
  /* Primary Colors */
  --primary-blue: #002868;    /* Deep blue representing data provenance */
...
Our stringent documentation standards ensure that ForgeBoard presents a consistent, professional, and patriotic image that reflects our commitment to data provenance and security. These standards aren't optional—they're an essential part of our mission to deliver secure, compliant, and visually distinctive documentation that stands out in the federal space.
