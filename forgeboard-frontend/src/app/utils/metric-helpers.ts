...
/**
 * Ensures a metric object has the required properties of ExtendedMetricData
 * @param metrics Original metrics object
 * @returns Properly formatted ExtendedMetricData
 */
export function ensureExtendedMetricData(metrics: MetricData | Partial<ExtendedMetricData>): ExtendedMetricData {
  return {
 ...
 */
export function createMockMetricData(): ExtendedMetricData {
  return {
