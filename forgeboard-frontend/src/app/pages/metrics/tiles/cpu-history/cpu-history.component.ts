...
export class CpuHistoryComponent
  implements OnInit, OnDestroy, AfterViewInit, Tile
{
  ...
  private initializeChart(): void {
    ...
    this.yAxis = this.g
      ...
      .attr('class', 'y-axis')
      .call(
        d3.axisLeft(y).ticks(5) as unknown as (
          selection: d3.Selection<SVGGElement, unknown, null, undefined>
        ) => void
      );
  ...
  private updateChart(): void {
    ...
    // Update line
    this.svg.select('.line').attr('d', pathData || '');
  }
}
